package gd.rf.thiagolemes.coursejava.config;
...
import gd.rf.thiagolemes.coursejava.entities.enums.OrderStatus;
import gd.rf.thiagolemes.coursejava.repositories.CategoryRepository;
import gd.rf.thiagolemes.coursejava.repositories.OrderRepository;
import gd.rf.thiagolemes.coursejava.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Criando a associação do Produto e Categoria
        ...
        //Salvando a associação no banco de dados
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
    }
}
